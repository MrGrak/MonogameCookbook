...
namespace Game1
{
    public static class CpuID
    {
        public static byte[] Invoke(int level)
        {
            ...
            try
            {
                ...
                if (IntPtr.Size == 4)
                {
                    ...
                    //Debug.WriteLine("x86 path");
                }
                else
                {
                    codeBytes = x64CodeBytes;
                    //Debug.WriteLine("x64 path");
                }
                ...
                CpuIDDelegate cpuIdDelg = 
                    (CpuIDDelegate)Marshal.GetDelegateForFunctionPointer(
                        codePointer, typeof(CpuIDDelegate));
        ...
        // This returns the CPU's manufacturer ID string – a 12 char
        ...
        private readonly static byte[] x86CodeBytes = {
            ...
            0x89, 0x4F, 0x0C,       // mov         dword ptr [edi+8], edx
            0x89, 0x57, 0x08,       // mov         dword ptr [edi+12], ecx
        ...
        private readonly static byte[] x64CodeBytes = {
            ...
            0x41, 0x89, 0x50, 0x08,     // mov    dword ptr [r8+8], edx
            0x41, 0x89, 0x48, 0x0c,     // mov    dword ptr [r8+12],  ecx
