...
namespace Game1
{
    ...
    //update: squarefaces are now structs, and they have hats

    //todo: apply gravity to squarefaces based on mouse pos
    //todo: apply screen boundary check
    //todo: add acceleration/velocity systems
    ...
    public static class GameManager
    {
        ...
        public static void Animate(ref SquareFace SF)
        {
            ...
            {
                SF.Timeline = 0;
                SF.Position.X += Data.Rand.Next(-2, 3);
            }

            //place skin and eyes at location
            SF.Face[0] = new Rectangle(SF.Position.X + 0, SF.Position.Y + 0, SF.FaceSize.X, SF.FaceSize.Y);
            SF.Face[1] = new Rectangle(SF.Position.X + 2, SF.Position.Y + 4, SF.EyeSize.X, SF.EyeSize.Y);
            SF.Face[2] = new Rectangle(SF.Position.X + 8, SF.Position.Y + 4, SF.EyeSize.X, SF.EyeSize.Y);
            SF.Face[3] = new Rectangle(SF.Position.X - 3, SF.Position.Y + SF.FaceSize.Y, SF.FaceSize.X + 6, 2);
            SF.Face[4] = new Rectangle(SF.Position.X + 2, SF.Position.Y - 2, 8, 3); //hat
            ...
            {
                SF.Face[1] = new Rectangle(SF.Position.X + 2, SF.Position.Y + 4, SF.EyeSize.X, 1);
                SF.Face[2] = new Rectangle(SF.Position.X + 8, SF.Position.Y + 4, SF.EyeSize.X, 1);
